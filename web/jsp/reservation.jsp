...
<div id="usual1" class="usual"> 
    ...
    <c:if test="${empty requestScope.labReservation_list}">
    	<center><b>当前日期之后该实验室未被预约，请放心预约。</b></center>
    </c:if>
    <c:if test="${not empty requestScope.labReservation_list}">
	<table class="tablelist">
	    ...
	    <tbody>
	    <c:forEach var="list" items="${requestScope.labReservation_list}" >
			<tr >
